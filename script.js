...
class App {
  ...
  _loadMap(position) {
    ...
    this.#map = L.map('map').setView(coords, this.#mapZoomLevel); //13 => zoom degree
  ...
  _moveToPopup(e) {
    ...
    console.log(workout);
    //leaflet properties //all of this from the library
...
//arrive to user location

//change between Elevation an Cadence
